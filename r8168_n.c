...
#ifdef __VMKLNX__
static int rtl8168_rx_interrupt(struct net_device *, struct rtl8168_private *, void __iomem *, u32 budget, u8 in_netpoll);
#else
...
static void rtl8168_reset_task(struct work_struct *work)
{
        ...
        rtl8168_wait_for_quiescence(dev);
#ifdef __VMKLNX__
	rtl8168_rx_interrupt(dev, tp, tp->mmio_addr, ~(u32)0, (u8)0);
#else
...
static int rtl8168_poll(napi_ptr napi, napi_budget budget)
{
        ...
        unsigned long flags;
#ifdef __VMKLNX__
	work_done = rtl8168_rx_interrupt(dev, tp, ioaddr, (u32) budget, 1);
#else
